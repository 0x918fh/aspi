 ...
 */
class Nomenclature extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'devices' => array(self::HAS_MANY, 'Device', 'nomenclature_id'),
			'group' => array(self::BELONGS_TO, 'NomenclatureGroup', 'group_id'),
		);
	}
	...
	public function getArray($condition){
		...
		if ($condition == NULL)
			...
			$record = Nomenclature::model()->findAll('group_id = :id', Array(':id' => $condition));
