...
class Organization extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'displacements' => array(self::HAS_MANY, 'Displacement', 'from_org'),
			'displacements1' => array(self::HAS_MANY, 'Displacement', 'to_org'),
			'rooms' => array(self::HAS_MANY, 'Room', 'organization_id'),
	...
	public function getArray($condition){
		...
		if ($condition == NULL)
			...
			$record = Organization::model()->findAll('id = :id', Array(':id' => $condition));
